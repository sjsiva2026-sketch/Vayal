...
const s = StyleSheet.create({
  ...
  docImg:       { width: '100%', aspectRatio: 1, borderRadius: rs(8), marginBottom: rs(4), backgroundColor: '#F3F4F6' },
  docImgEmpty:  { width: '100%', aspectRatio: 1, borderRadius: rs(8), backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center', marginBottom: rs(4) },
