      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        <LinearGradient colors={['#145A3E', '#1C7C54']} style={s.header}>
          ...
          {userProfile?.isLocked && (
            <TouchableOpacity style={s.lockPill} onPress={() => navigation.navigate('Payment')}>
...
const s = StyleSheet.create({
  ...
  phonePill:       { backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 6, marginBottom: 8 },
  phonePillTxt:    { fontSize: 14, fontWeight: '700', color: '#fff' },
  lockPill:        { backgroundColor: '#EF4444', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 6, marginTop: 6 },
  lockPillTxt:     { fontSize: 13, fontWeight: '700', color: '#fff' },
