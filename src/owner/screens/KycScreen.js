      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={s.section}>
            ...
            <TextInput style={s.input} value={name} onChangeText={setName} placeholder="e.g. Muthu Selvam" placeholderTextColor="#C9D1DA" autoCapitalize="words" />
          </View>

          <View style={s.section}>
            <Text style={s.label}>Vehicle Number <Text style={s.req}>*</Text></Text>
            <TextInput style={[s.input, { letterSpacing: 2, fontWeight: '700' }]} value={vehicleNum} onChangeText={t => setVehicleNum(t.toUpperCase())} placeholder="e.g. TN59AB1234" placeholderTextColor="#C9D1DA" autoCapitalize="characters" />
          </View>

          <View style={s.section}>
            <Text style={s.label}>Profile Photo <Text style={s.req}>*</Text></Text>
            <UploadSlot label="Profile Photo" icon="📷" asset={profileAsset} onPick={() => pick(setProfileAsset)} required />
          </View>

          <View style={s.section}>
            <Text style={s.label}>Documents <Text style={s.req}>*</Text></Text>
            <View style={s.twoCol}>
              <UploadSlot label="Driving License" icon="📄" asset={licenseAsset} onPick={() => pick(setLicenseAsset)} required style={{ flex: 1, marginRight: rs(8) }} />
              <UploadSlot label="Aadhar Card" icon="🪪" asset={aadharAsset} onPick={() => pick(setAadharAsset)} required style={{ flex: 1 }} />
            </View>
          </View>
          ...
          <View style={s.infoBox}>
            ...
            <Text style={s.infoTxt}>Documents stored securely. Admin will verify within a few hours. This page updates automatically when approved.</Text>
          </View>
...
const s = StyleSheet.create({
  ...
  docRow:         { flexDirection: 'row', alignItems: 'center', marginBottom: rs(10) },
  docCheck:       { color: '#1C7C54', fontWeight: '900', fontSize: rf(16), marginRight: rs(10) },
  docItem:        { fontSize: rf(14), color: '#374151' },
